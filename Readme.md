...
- Студент: [Yurii Timchenko](https://up.htmlacademy.ru/htmlcss/27/user/486431).
- Наставник: `Work by myself`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/486431-sedona-27) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
